...
public class RedisCacheController {
    ...
    @GetMapping("/template")
    public Object queryTemplate(){
        cacheService.queryTemplate(102);

        return "SUCCESS";
    }

    @PostMapping("/find")
    public Object queryTemplate(@RequestBody FindTemplateParams params){
        return cacheService.queryTemplateInfo(params);
    }
}
